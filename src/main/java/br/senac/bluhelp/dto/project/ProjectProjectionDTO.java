...
public record ProjectProjectionDTO(Long id, Long creator, String creatorName, String creatorSurname, String title, 
		String objective, Long address, String district, String description, List<CategoryProjection> categories, Progress progress, byte[] photo, LocalDateTime date, float averageReview) {
}
